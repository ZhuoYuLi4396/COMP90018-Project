...
public class AlgorithmTestActivity extends AppCompatActivity {
        ...
        btnDone.setOnClickListener(v -> {
            ...
            try{
                ...
                try {
                    ...
                    // 参与方人数数量作为分母
                    java.util.List<String> lines = calculateSplits(payer, participants, amount);

                    if (lines.isEmpty()) {
                        android.widget.Toast.makeText(this, "No debts generated.", android.widget.Toast.LENGTH_SHORT).show();
                        return;
                    }
    ...
    private java.util.List<String> calculateSplits(String payer,
        ...
        if (uniq.isEmpty()) return new java.util.ArrayList<>();
        ...
        // 先给每个欠款人分配四舍五入到分的份额
        java.util.List<java.math.BigDecimal> shares = new java.util.ArrayList<>();
